...
export function CreateVoucherForm({ onClose, onSuccess }: CreateVoucherFormProps) {
  ...
  return (
    <Card className='max-w-4xl mx-auto border-[#004643]/20 shadow-lg bg-white'>
      <CardHeader className='bg-[#f0f7f6] border-b border-[#004643]/10'>
        <CardTitle className='text-2xl font-bold text-[#004643]'>Tạo Voucher Mới</CardTitle>
