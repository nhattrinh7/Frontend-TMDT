...
import { KeyRound, Eye, EyeOff, Save, Loader2, RotateCcw, ArrowLeft, Send } from 'lucide-react'
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
      ...
      <div>
        ...
        {errors.confirmPassCode && (
          <p className='mt-1 text-sm text-red-500'>{errors.confirmPassCode.message}</p>
        )}
      </div>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
      <div>
        ...
        {errors.currentPassCode && (
          <p className='mt-1 text-sm text-red-500'>{errors.currentPassCode.message}</p>
        )}
      </div>
      ...
      <div>
        ...
        />
        {errors.newPassCode && (
          <p className='mt-1 text-sm text-red-500'>{errors.newPassCode.message}</p>
        )}
      </div>
