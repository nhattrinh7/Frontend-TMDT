...
import { AdminOrder } from '~/apiRequests/order.apiRequest'
...
export default function AdminOrderDetailsDialog({ order }: AdminOrderDetailsDialogProps) {
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant='outline'
          size='sm'
          className='border-[#004643] text-[#004643] hover:bg-[#f0f9f8]'
        >
          Xem chi tiết
        </Button>
      </DialogTrigger>
          ...
          <div>
            ...
            <div className='grid grid-cols-1 gap-2 text-sm bg-muted/30 p-4 rounded-md'>
              ...
              <div className='flex justify-between'>
                ...
                <span className='font-medium'>{order.receiverPhoneNumber}</span>
              </div>
            ...
            <>
              ...
              <div>
                ...
                <div className='bg-orange-50 p-3 rounded-md text-sm border border-orange-100 grid gap-2'>
                  <div className='flex justify-between gap-4'>
                    <span className='text-muted-foreground whitespace-nowrap'>Lý do hoàn:</span>
                  ...
                  <div className='flex justify-between'>
                    <span className='text-muted-foreground'>Phương án hoàn:</span>
