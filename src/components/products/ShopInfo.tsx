          ...
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex gap-3 mt-4'>
              <button
                ...
                className='flex items-center justify-center gap-2 border-2 border-emerald-600 text-emerald-600 px-5 py-2 text-sm font-semibold rounded-lg bg-emerald-50 hover:bg-emerald-600/10 transition-colors'
              >
                <svg
                  className='h-5 w-5'
                  fill='none'
              ...
              <Link
                href={`/shop/${shop.id}`}
                className='flex items-center justify-center gap-2 border-2 border-slate-200 px-5 py-2 text-sm font-semibold rounded-lg hover:bg-slate-50 text-slate-700 transition-colors'
              >
                <svg
                  className='h-5 w-5'
                  fill='none'
